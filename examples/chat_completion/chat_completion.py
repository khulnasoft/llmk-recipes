...
from llmk_recipes.inference.chat_utils import read_dialogs_from_file, format_tokens
from llmk_recipes.inference.model_utils import load_model, load_peft_model
from llmk_recipes.inference.safety_utils import get_safety_checker
...
def main(
    ...
    enable_llmkguard_content_safety: bool = False,
    **kwargs
):
    ...
    tokenizer = LlmkTokenizer.from_pretrained(model_name)
    ...
    with torch.no_grad():
        for idx, chat in enumerate(chats):
            safety_checker = get_safety_checker(enable_azure_content_safety,
                                        ...
                                        enable_llmkguard_content_safety,
                                        )
