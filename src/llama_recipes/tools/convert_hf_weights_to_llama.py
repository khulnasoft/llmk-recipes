...
from transformers import LlmkForCausalLM  # @manual
...
def main(
    ...
    """Convert llmk weights from huggingface format to consolidated format.
    params:
    model_path: model name or path to the model directory.
    model_size: Llmk model size, one of 7B, 13B, 34B, 30B, 65B, 70B.
    output_dir: directory to save Llmk weights, should contains params.json.
    """
