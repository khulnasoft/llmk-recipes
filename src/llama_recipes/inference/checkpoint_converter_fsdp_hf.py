...
from llmk_recipes.inference.model_utils import  load_llmk_from_config
...
def main(
    ...
    HF_model_path_or_name="" # Path/ name of the HF model that include config.json and tokenizer_config.json (e.g. khulnasoft-llmk/Llmk-2-7b-chat-hf)
    ):
    ...
    model_def = load_llmk_from_config(HF_model_path_or_name)
    ...
    tokenizer = LlmkTokenizer.from_pretrained(HF_model_path_or_name)
