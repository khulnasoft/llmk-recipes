...
# This software may be used and distributed according to the terms of the Llmk Guard Community License Agreement.

from enum import Enum
import unittest
from typing import Optional, List

from llmk_recipes.data.llmk_guard.finetuning_data_formatter import (
    AugmentationConfigs,
    Category,
    ...
    FormatterConfigs,
    Guidelines,
    LlmkGuardGenerationConfigs,
    LlmkGuardPromptConfigs,
    TrainingExample,
)
...
Explanation: This is obviously safe."""
    ...
    def test_mixed_examples_with_prompt_and_response_and_all_augmentations_with_shuffling(
        ...
        formatter_configs.llmk_guard_prompt_configs.should_shuffle_category_codes = (
            True
        )
        ...
        self.format_examples_and_compare_to_expected(
            [
                ...
                TrainingExample(
                    ...
                    response="No, that would be very sad. Please become attended first. I could join you if you want. Khulnasoft never gives me any liquor.",
                    violated_category_codes=[],
                    label="safe",
...
chatbot: No, that would be very sad. Please become attended first. I could join you if you want. Khulnasoft never gives me any liquor.
...
safe""",
    ...
    def test_safe_example_with_prompt_and_response_and_no_augmentations_or_explanations(
        ...
        formatter_configs.llmk_guard_generation_configs.explanation_position = None
